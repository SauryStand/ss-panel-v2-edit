            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="box box-solid">
                        ...
                        <div class="box-body">
                            <p>流量每月重置，还可以通过签到获取流量。</p> 
                            <p>可在节点列表的操作——客户端获取一键添加ss信息方法（包括ss://地址和二维码方式）。</p> 
                        </div><!-- /.box-body -->
                    </div><!-- /.box -->
                </div><!-- /.col (right) -->
                ...
                <div class="col-md-6">
                    <div class="box box-solid">
                        ...
                        <div class="box-body">
                            <p> SS地址：<code>在节点列表查看</code> </p>
                            
                            <p> SS端口：<code><?php echo $oo->get_port();?></code> </p>
                            <p> SS密码：<code><?php echo $oo->get_pass();?></code> </p>
                            <p>状态:
                            <?php
